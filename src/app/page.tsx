...
const plans = [
  ...
  },
  {
    ...
    prijs: "€9",
    periode: "/maand",
    beschrijving: "Volledige controle over je verhuuractiviteit.",
    kenmerken: [
      "3 kalenders",
      "Alles van Basic",
      "Inkomsten bijhouden per periode",
      "Exporteren naar PDF/Excel",
      "Seizoensprijzen bijhouden",
      "Prioritair support",
    ],
    nee: [],
  ...
  },
  {
    ...
    prijs: "€19",
    periode: "/maand",
    beschrijving: "Voor verhuurders met meerdere woningen.",
    kenmerken: [
      "Tot 10 kalenders",
      "Alles van Premium",
      "Overzicht over alle woningen",
      "Statistieken per woning",
