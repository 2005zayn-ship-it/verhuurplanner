...
const faqs = [
  ...
  { v: "Wat is de iCal URL en waarvoor gebruik ik die?", a: "De iCal URL is een link waarmee je je kalender kunt synchroniseren met externe agenda-apps zoals Google Agenda, Outlook of Apple Kalender. Je vindt de URL in je kalenderinstellingen onder het tabblad 'iCal URL'. Kopieer de link en voeg hem toe als agenda-abonnement in je favoriete app." },
  { v: "Werkt de iCal URL met Google Agenda?", a: "Ja. Open Google Agenda, klik op het plusteken naast 'Andere agenda's' en kies 'Via URL'. Plak de iCal URL en klik op 'Agenda toevoegen'. Je bezettingen verschijnen automatisch in je Google Agenda en worden regelmatig bijgewerkt." },
  { v: "Kan ik de iCal URL gebruiken met boekingssystemen zoals Airbnb of Booking.com?", a: "Ja. De meeste boekingssystemen ondersteunen het importeren van een iCal-feed. Zo houd je je beschikbaarheid op meerdere platforms gesynchroniseerd zonder alles manueel in te voeren." },
